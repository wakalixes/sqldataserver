...
class PureDataServerWindow(QtGui.QMainWindow, Ui_PureServerMainWindow):
  ...
  def prepareConditionWriting(self):
    ...
    try:
      ...
      self.dbcur.execute("CREATE TABLE IF NOT EXISTS conditionTable (id VARCHAR(255), Dataset VARCHAR(50), Date VARCHAR(50), Conditions TEXT, axes VARCHAR(255), fitplugin VARCHAR(255), transformplugin VARCHAR(255), fitparameters VARCHAR(255), transformparameters VARCHAR(255), Temperature VARCHAR(100), Holding VARCHAR(100), Trap VARCHAR(50), Ramping VARCHAR(50), Compressed VARCHAR(50), Calibration VARCHAR(50), Text TEXT);")
